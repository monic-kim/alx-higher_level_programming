...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Raises:
           TypeError:if either the with or  height is not an int
    ...
    @property
    def x(self):
        """set the x coordinate of rectagle"""
        return self.__x
    ...
    def area(self):
        """Return the are a of rectangle"""
        return self.width * self.height

    def display(self):
        """print tne rectangle using the # character."""
    ...
    def update(self, *args, **kwargs):
        ...
        Args:
           *args (ints):New attribute values
            ...
            **kwargs (dict): New key pairs attributes
        """
